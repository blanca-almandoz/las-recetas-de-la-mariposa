...
const NavBar = () => {
  ...
  const handleClick = () => {
    ...
    return (
    <nav className="bg-gray-800" style={{position:'fixed', width:'100%', zIndex: 2,}}>
   ...
   {/*  <!-- Mobile menu, show/hide based on menu state. --> */}
    {onOpen && <div className="sm:hidden" id="mobile-menu">
      <div className="space-y-1 px-2 pb-3 pt-2">
        ...
        <Link href="/recipes/desserts" onClick={handleClick} className={clsx("text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium",
                                                            {'bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium' : pathname === '/recipes/desserts'},
                                                      )}>Postres</Link>
        <Link href="/recipes/siders" onClick={handleClick} className={clsx("text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium",
                                                            {'bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium' : pathname === '/recipes/siders'},
                                                      )}>Salsas y guarniciones</Link>
      </div>
    </div>}
